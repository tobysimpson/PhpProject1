        ...
        <table class="table1">
            ...
            <xsl:for-each select="//root/tbl[4]/row">
                <tr>
                    ...
                    <td><xsl:value-of select="format-number(@mc_w1,'#,##0.0000','fmt1')"/></td>
                    <td>
                        <xsl:value-of select="@scn_id1"/>
                    </td>
                    <td>
                        <xsl:value-of select="@scn_id2"/>
                    </td>
                    <td style="text-align:right">
                        <xsl:value-of select="format-number(@u1,'#,##0.0000','fmt1')"/>
                    </td>
                    <td style="text-align:right">
                    ...
                    <td style="text-align:right">
                        <xsl:value-of select="format-number(@p1,'#,##0.0000','fmt1')"/>
                    </td>
                    <td style="text-align:right">
                        <xsl:value-of select="format-number(@p1,'#,##0.0000','fmt1')"/>
                    </td>
                    ...
                    <td style="text-align:right">
                        <xsl:value-of select="format-number(@phi,'#,##0.0000','fmt1')"/>
                    </td>
                </tr>
            </xsl:for-each>
        </table>
