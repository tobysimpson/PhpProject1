...
//    $name0 = $_FILES["upfile"]["name"];
    ...
    $sql2 = "LOAD DATA INFILE '" . $name2 . "' IGNORE INTO TABLE db2.in_prem1 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' (sector,variable,year,region,model,scenario,impact,location,value,unit);";
    //LINES TERMINATED BY '\r\n'
